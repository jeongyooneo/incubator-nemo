 ...
 */
public final class StaticDisaggPolicyParallelismFive implements Policy {
  private final Policy policy;

  public StaticDisaggPolicyParallelismFive() {
    this.policy = new PolicyImpl(
        PolicyTestUtil.overwriteParallelism(5,
          StaticDisaggPolicy.BUILDER.getCompileTimePasses()),
        StaticDisaggPolicy.BUILDER.getRuntimePasses());
  }
