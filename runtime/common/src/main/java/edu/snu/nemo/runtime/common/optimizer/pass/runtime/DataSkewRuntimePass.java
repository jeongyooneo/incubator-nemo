...
public final class DataSkewRuntimePass implements RuntimePass<Pair<List<String>, Map<Integer, Long>>> {
  ...
  public PhysicalPlan apply(final PhysicalPlan originalPlan,
    ...
    // Calculate keyRanges.
    final List<KeyRange> keyRanges = calculateHashRanges(metricData.right(), taskGroupListSize);
   ...
   */
  @VisibleForTesting
  public List<KeyRange> calculateHashRanges(final Map<Integer, Long> aggregatedMetricDataMap,
